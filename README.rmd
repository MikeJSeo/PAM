...
That will bring up a browser window with a user interface. More details are provided in the manual pam.pdf in this directory

Please post to the group regarding any issues. This will help us ensure we have all the kinks ironed out before merging the code into the next version of the `pamr` package.
